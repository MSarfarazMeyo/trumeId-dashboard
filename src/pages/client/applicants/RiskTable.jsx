...
const RiskTable = () => {
  ...
  const getRiskLevelColor = (level) => {
    if (level == "high") return "#EA0606";
    if (level == "medium") return "#FADD33";
    if (level == "low") return "#00E052";
    return "#00E052";
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (riskLevel, record) => (
        <span
          style={{
            color: getRiskLevelColor(riskLevel || "low"),
          }}
          className="text-gray-600"
        >
          {getRiskLevelText(riskLevel || "low") || "-"}
        </span>
      ),
    },
    {
      ...
      dataIndex: "riskScore",
      key: "riskScore",
      render: (riskScore, record) => {
        return (
          <div
            className="flex space-x-2"
            style={{
              color: getRiskLevelColor(record.riskLevel || "low"),
            }}
          >
            {riskScore || 0}
          </div>
